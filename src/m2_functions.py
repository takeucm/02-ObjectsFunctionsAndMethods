...
def turtle4():
    mako = rg.SimpleTurtle()
    mako.pen = rg.Pen('blue',10)
...
def turtle5():
    take = rg.SimpleTurtle()
    take.pen = rg.Pen('red', 20)

    take.draw_circle(40)

    uchi = rg.SimpleTurtle()
    uchi.pen = rg.Pen('green',30)
